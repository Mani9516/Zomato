...
if analysis_type == "Restaurant Type Count":
    st.image(restaurant_type_count(), use_container_width=True)
elif analysis_type == "Votes by Restaurant Type":
    st.image(votes_by_type(), use_container_width=True)
elif analysis_type == "Rating Distribution":
    st.image(rating_distribution(), use_container_width=True)
elif analysis_type == "Cost Distribution":
    st.image(cost_distribution(), use_container_width=True)
elif analysis_type == "Online vs Offline Rating":
    st.image(online_vs_offline_rating(), use_container_width=True)
elif analysis_type == "Heatmap: Type vs Online Order":
    st.image(heatmap_type_online(), use_container_width=True)
